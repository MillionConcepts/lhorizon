"""
This is a near copy of the Python 3.12.7 telnetlib module (deprecated in 3.13).

As such, it bears the PSF License Agreement for Python 3.12.7:
https://docs.python.org/3.12/license.html. See this package's LICENSE file
for a complete copy of that license.
