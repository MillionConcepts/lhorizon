...
CYDONIA_PALM_SPRINGS_1959_TOPO = {
    ...
    "vz_10_13": (642.37758527, 646.50752001, 650.66857344)
}
...
WEIRD_OPTIONS = {
    "init_kwargs": {
        "epochs": {"start": "1991-01-01", "stop": "1991-01-10", "step": "6h"},
        "query_options": {
            "airmass_lessthan": 80,
    ...
    "=80&SKIP_DAYLT=YES",
    "ra_app_icrf_r_7_8_9": (205.117670355, 208.077898293, 211.058503382),
}
